...
const BACKEND_NAME: &str = "glance-mcp-backend.exe";
const BACKEND_PORT: u16 = 10776;
const BACKEND_TAG: &str = "glance-mcp-backend-x86_64-pc-windows-msvc.exe";
const ENV_PORT: &str = "GLANCE_MCP_PORT";
const ENV_HOST: &str = "GLANCE_MCP_HOST";
const ENV_TAURI: &str = "GLANCE_MCP_TAURI";
